...
<<<<<<< HEAD
                            <Link
                              href="/retina">
                              <div className="flex items-center justify-center w-full py-3 font-medium text-white rounded-md text-lg px-10 bg-guindaOscuro hover:bg-guindaClaro">
                                <span>Ver mas</span>
...
>>>>>>> ae3dad0478848e1c4f8df9f10248163d5c4df2a3
                            </Link>
                          </div>
                        </div>
                      </div>
