                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 xl:gap-10 pt-10">
                            ...
                            <div className="px-3 py-8 text-center rounded-lg">
                                ...
                                <p className="text-slate-600 text-xl leading-relaxed pt-6">
                                    Capacitación para el diagnóstico y manejo de glaucoma simple y complejo.
                                </p>
                            </div>
                            ...
                            <div className="px-3 py-8 text-center rounded-lg">
                                ...
                                <p className="text-slate-600 text-xl leading-relaxed pt-6">
                                    Tiempo completo y dedicación exclusiva con horarios variables de acuerdo a la disponibilidad de los docentes, así como atención de 
                                    urgencias.
                                </p>
                            </div>
                        </div>
