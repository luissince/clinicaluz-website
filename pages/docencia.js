            ...
            <div className=" font-normal m-0 ">
                ...
                <div className="flex flex-col min-h-screen overflow-hidden">
                    ...
                    <main className="grow">
                                ...
                                <div className="pt-36 md:pt-40 md:pb-20 ">
                                    ...
                                    <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
                                        ...
                                        <div className="md:w-[600px]">
                                            ...
                                            <p className="text-[1.125rem] leading-6 -tracking-[0.01em] text-white/100 mb-8">Our landing page template works on all devices, so you only
                                            ...
                                            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center md:justify-start st hp hh mb-12 md:mb-0">
                                                <div className="mt-3">
                                                    <a className="px-4 py-2 w-full inline-flex items-center text-white/100 bg-slate-900/100 ci cq shadow-sm justify-center whitespace-nowrap rounded-[9999px] text-sm font-medium" href="">
                                                        Get your card
                                                        <span className="tracking-normal text-white/100 cz transition-transform duration-150 ease-in-out ml-2">
                                                ...
                                                <div className="ml-2 mt-3">
                                                    <a className="px-4 py-2 w-full inline-flex items-center text-white/100 bg-gradient-to-r from-violet-500 to-fuchsia-500 cs shadow-sm relative lc lh lv lm lp ld justify-center whitespace-nowrap rounded-[9999px] text-sm font-medium" href="support.html">Read documentation</a>
                                                </div>
                                            </div>
                                        ...
                                        <div className="max-w-sm mx-auto md:max-w-none md:absolute md:left-[600px] md:top-0 -mb-12 md:-mt-12 md:mb-0">
                                            <div className="relative -ml-3 -mr-24 md:mx-0">
                                                ...
                                                <img src="/images/hero-image.png" className="md:max-w-none drop-shadow-[0_60px_60px_rgba(0,0,0,0.50)]" width="548" height="545" alt="Credit card" />
                                            </div>
                                        </div>
                        ...
                        <section className="py-16 sm:scroll-mt-32 sm:py-20 lg:py-32">
                            <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:max-w-4xl lg:px-12">
                                ...
                                <p className="mt-4 text-lg tracking-tight text-slate-700">
                                    Design assets, icon teardowns, and a community of fellow icon designers where you can ask questions, get feedback, and accelerate
                                    your learning.
                                </p>
                            </div>
                            ...
                            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                                <div className="py-2 md:py-2">
                                    ...
                                    <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                                        <h2 class="md:text-5xl md:tracking-[0] text-[2.25rem] leading-none tracking-[0] font-extrabold">
                                    ...
                                    <div>
                                        {/* <!-- Section content --> */}
                                        <div class="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row hw pp pd so sp hx">

                                            {/* <!-- Content --> */}
                                            <div class="md:w-[58.333333%] lg:w-1/2 order-1 md:order-none" data-aos="fade-up">
                                                {/* <!-- Content #1 --> */}
                                                <div x-show="category === '1'">
                                                    <h3 class="text-[1.875rem] leading-[1.333] tracking-[0] font-extrabold md:text-[2.25rem] md:leading-none md:tracking-[0] mb-3">The member-owned tech society.</h3>
                                                    <p class="text-[1.125rem] leading-normal -tracking-[0.01em] text-gray-500 mb-8">Work is is changing faster than at any other time in history. This rapid change requires a new hiring model. A model that is fair, inclusive, and empowering. That's why we built this.</p>
                                                    <ul class="inline-flex flex-col list-none m-0 p-0 su">
                                                        <li class="flex items-start">
                                                            <svg class="w-3 h-3 fill-current text-guindaOscuro mt-[0.375rem] mr-[0.75rem] shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z"></path>
                                                            </svg>
                                                            <div>
                                                                <div class="font-bold text-[1.125rem] leading-normal -tracking-[0.01em] mb-1">Ensure Quick Turnarounds</div>
                                            ...
                                            {/* <!-- Image --> */}
                                            <div class="md:w-[41.666667%] lg:w-1/2" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <section>
                            <div class="container py-32 md:py-32 mx-auto">
                                <h2 class="text-center text-4xl font-semibold uppercase text-guindaClaro sm:text-5xl lg:text-6xl">
                                    Aqui hay un formulario de contacto
                                </h2>
                                <h4 class="pt-6 text-center text-xl font-medium text-guindaOscuro sm:text-2xl lg:text-3xl">
                                ...
                                <form class="mx-auto w-full pt-10 sm:w-3/4">
                                    <div class="flex flex-col md:flex-row">
                                        <input class="mr-3 w-full rounded border-[1px] border-gray-400 px-4 py-3 font-body text-black md:w-1/2 lg:mr-5" placeholder="Nombre"/>
                                        <input class="mt-6 w-full rounded border-[1px] border-gray-400 px-4 py-3 font-body text-black md:mt-0 md:ml-3 md:w-1/2 lg:ml-5" placeholder="Email" type="text" id="email" />
                                    </div>
                                    <textarea class="mt-6 w-full rounded border-[1px] border-gray-400 px-4 py-3 font-body text-black md:mt-8" placeholder="Mensaje" id="message" cols="30" rows="10"></textarea>
                                    <button class="mt-6 flex items-center justify-center rounded bg-guindaClaro px-8 py-3 font-header text-lg font-bold uppercase text-white hover:bg-grey-20">
                                        Enviar
